...
class FrontPassportPhotoConfirmation : PhotoConfirmationFragment() {

    override fun setupViews() {
        super.setupViews()
        vb.tvConfirmTitle.setText(R.string.process_flow_photo_confirmation_passport)
    }

    companion object {
        fun create(filePath: String?, scaleType: ImageView.ScaleType? = null): PhotoConfirmationFragment {
            return FrontPassportPhotoConfirmation().apply {
                arguments = bundleOf(
